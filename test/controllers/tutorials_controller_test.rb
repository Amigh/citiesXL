...
class TutorialsControllerTest < ActionController::TestCase
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post :create, tutorial: { description: @tutorial.description, title: @tutorial.title, video: @tutorial.video }
    end
  ...
  test "should update tutorial" do
    patch :update, id: @tutorial, tutorial: { description: @tutorial.description, title: @tutorial.title, video: @tutorial.video }
    assert_redirected_to tutorial_path(assigns(:tutorial))
  end
